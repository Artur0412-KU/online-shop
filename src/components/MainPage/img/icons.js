...
import CallIconWhite from './icons/phone-icon-white.svg'
import NextIcon from './icons/next-icon.png';
import BasketIcon from './icons/basket-icon.svg';
import BasketIconWhite from './icons/basket-icon-white.svg';
import HeartIcon from './icons/heart-icon.svg';
import HeartIconWhite from './icons/heart-icon-white.svg';
...
export {CallIcon, CallIconWhite, NextIcon, BasketIcon, BasketIconWhite, 
    HeartIcon, HeartIconWhite, UserIcon, UserIconWhite, RightIcon, 
    RightIconClick, Samsung, Smartphone, svgCard, svgCardClick, svgLike, svgLikeH, svgCardHover, Laptop
}