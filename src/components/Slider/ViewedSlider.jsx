...
import PrevIcon from '../../assets/img/icons/prev-icon.png';
import NextIcon from '../../assets/img/icons/next-icon.png';
import PrevIconHover from '../../assets/img/arrow-prev-hover.png';
import NextIconHover from '../../assets/img/arrow-next-hover.png';
import NextIconClick from '../../assets/img/arrow-next-click.png';
import PrevIconClick from '../../assets/img/arrow-prev-click.png';
